...
- Once on the node, set required env vars and run: `export ES_HOST='<opensearch-endpoint>' && export ES_PORT='443' && export ES_SCHEME='https' && export SPARK_MASTER='yarn' && export PROJECT_LIST='["pcdc-20260414"]' && export INDEX_NAME='pcdc_20260414' && /home/hadoop/etl_venv/bin/python3 etl.py`
